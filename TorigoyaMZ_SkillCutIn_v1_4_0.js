/*---------------------------------------------------------------------------*
 * TorigoyaMZ_SkillCutIn.js v.1.4.0
 *---------------------------------------------------------------------------*
    ...
    function readStructActorCutinSet(parameters) {
        ...
        return {
            ...
            backTone: readStructColorCustomize(
                parseStructObjectParam(parameters['backTone'], { isUse: false, red: -128, green: -128, blue: 128 }),
            ),
            borderTone: readStructColorCustomize(
                parseStructObjectParam(parameters['borderTone'], { isUse: false, red: 0, green: 0, blue: 0 }),
            ),
    ...
    function readParameter() {
        ...
        return {
            ...
            commonSound: readStructSound(
                parseStructObjectParam(parameters['commonSound'], { name: 'Skill2', volume: 90, pitch: 100, pan: 0 }),
            ),
            ...
            actorBackTone: readStructColor(
                parseStructObjectParam(parameters['actorBackTone'], { red: -128, green: -128, blue: 128 }),
            ),
            actorBorderTone: readStructColor(
                parseStructObjectParam(parameters['actorBorderTone'], { red: 0, green: 0, blue: 0 }),
            ),
            ...
            enemyBackTone: readStructColor(
                parseStructObjectParam(parameters['enemyBackTone'], { red: 128, green: -128, blue: -128 }),
            ),
            enemyBorderTone: readStructColor(
                parseStructObjectParam(parameters['enemyBorderTone'], { red: 0, green: 0, blue: 0 }),
            ),
        };
    }
