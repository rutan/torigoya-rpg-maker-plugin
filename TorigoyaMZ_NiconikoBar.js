/*---------------------------------------------------------------------------*
 * TorigoyaMZ_NiconikoBar.js v.1.1.0
 *---------------------------------------------------------------------------*
 * 2020/08/23 16:55 (JST)
 *---------------------------------------------------------------------------*
 * Ruたん ( @ru_shalm )
...
/*:
 * @target MZ
 * @plugindesc ニコニ広告通知バー風表示プラグイン (v.1.1.0)
 * @author Ruたん（ru_shalm）
 * @license public domain
 * @version 1.1.0
 * @help
 * ニコニ広告通知バー風表示プラグイン (v.1.1.0)
 *
 ...
 * @command start
 * @text ニコニ広告情報の取得開始
 * @desc ニコニ広告情報の取得を開始します。取得した場合自動的にバーを表示します。
 *
 * @command stop
 * @text ニコニ広告情報の取得停止
 * @desc ニコニ広告情報の取得を停止します。停止中はバーが表示されません。
 */
...
(function () {
    ...
    function getPluginName() {
        ...
        return cs ? cs.src.split('/').pop().replace(/\.js$/, '') : 'TorigoyaMZ_NiconikoBar';
    }
    ...
    function readParameter() {
        ...
        return {
            version: '1.1.0',
            testUseDebugMode: pickBooleanValueFromParameter(parameter, 'testUseDebugMode'),
            baseTitle: pickStringValueFromParameter(parameter, 'baseTitle'),
            baseMessage: pickStringValueFromParameter(parameter, 'baseMessage'),
            baseBackgroundColor: pickStringValueFromParameter(parameter, 'baseBackgroundColor'),
            baseTextColor: pickStringValueFromParameter(parameter, 'baseTextColor'),
            baseScrollTime: pickNumberValueFromParameter(parameter, 'baseScrollTime'),
            advancedAutoStart: pickBooleanValueFromParameter(parameter, 'advancedAutoStart'),
            advancedExpiration: pickNumberValueFromParameter(parameter, 'advancedExpiration'),
            advancedFetchInterval: pickNumberValueFromParameter(parameter, 'advancedFetchInterval'),
        };
    }
