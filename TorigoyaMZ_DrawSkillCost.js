/*---------------------------------------------------------------------------*
 * TorigoyaMZ_DrawSkillCost.js v.1.0.0
 *---------------------------------------------------------------------------*
 * 2020/09/02 00:23 (JST)
 *---------------------------------------------------------------------------*
 * Ruたん ( @ru_shalm )
...
(function () {
    ...
    function readParameter() {
        ...
        return {
            version: '1.0.0',
            labelFontSize: pickNumberValueFromParameter(parameter, 'labelFontSize'),
            valueFontSize: pickNumberValueFromParameter(parameter, 'valueFontSize'),
            gapSize: pickNumberValueFromParameter(parameter, 'gapSize'),
        };
    }
