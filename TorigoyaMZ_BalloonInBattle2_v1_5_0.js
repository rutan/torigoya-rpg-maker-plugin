/*---------------------------------------------------------------------------*
 * TorigoyaMZ_BalloonInBattle2.js v.1.5.0
 *---------------------------------------------------------------------------*
 * 2022/02/05 01:57 (JST)
 *---------------------------------------------------------------------------*
 * Ruたん ( @ru_shalm )
...
/*:
 * @target MZ
 * @plugindesc 戦闘中セリフ表示プラグイン (v.1.5.0)
...
(function () {
    ...
    function readParameter() {
        ...
        return {
            ...
            advancedLayerPosition: pickStringValueFromParameter(parameter, 'advancedLayerPosition', 'normal'),
        };
    }
    ...
    (() => {
        ...
        function commandTalkActorByText({ actorId, text }) {
            ...
            subject.torigoyaBalloonInBattle_setMessageParameter('manualMessage-'.concat(Date.now()), text);
        }
