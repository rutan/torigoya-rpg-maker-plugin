/*---------------------------------------------------------------------------*
 * TorigoyaMZ_NotifyMessage.js v.1.3.0
 *---------------------------------------------------------------------------*
...
/*:
 * @target MZ
 * @plugindesc 通知メッセージプラグイン (v.1.3.0)
...
(function () {
    ...
    function readParameter() {
        ...
        return {
            ...
            baseLeftPadding: pickIntegerValueFromParameter(parameter, 'baseLeftPadding', 0),
            baseRightPadding: pickIntegerValueFromParameter(parameter, 'baseRightPadding', 30),
