/*---------------------------------------------------------------------------*
 * TorigoyaMZ_NotifyMessage_AddonAtsumaruGlobalSignal.js v.1.0.1
 *---------------------------------------------------------------------------*
 * 2022/05/21 21:43 (JST)
 *---------------------------------------------------------------------------*
 * Ruたん ( @ru_shalm )
...
/*:
 * @target MZ
 * @plugindesc 通知メッセージアドオン: アツマールグローバルシグナル通知ログ (v.1.0.1)
 ...
 * @help
 * 通知メッセージアドオン: アツマールグローバルシグナル通知ログ (v.1.0.1)
 * https://torigoya-plugin.rutan.dev
 *
