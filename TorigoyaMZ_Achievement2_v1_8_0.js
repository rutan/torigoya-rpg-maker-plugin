/*---------------------------------------------------------------------------*
 * TorigoyaMZ_Achievement2.js v.1.8.0
 *---------------------------------------------------------------------------*
 * Build Date: 2024/01/19 01:57:12 (JST)
 *---------------------------------------------------------------------------*
 * Ruたん ( @ru_shalm )
...
(function () {
    ...
    function readStructAchievement(parameters) {
        ...
        return {
            ...
            description: parseStringParam(parameters['description'], ''),
            icon: parseIntegerParam(parameters['icon'], 0),
            hint: parseStringParam(parameters['hint'], ''),
    ...
    function readParameter() {
        ...
        return {
            ...
            popupSound: readStructSound(
                parseStructObjectParam(parameters['popupSound'], { soundName: 'Saint5', soundVolume: 90 }),
            ),
