/*---------------------------------------------------------------------------*
 * TorigoyaMZ_Achievement2_AddonRewardPicture.js v.1.1.0
 *---------------------------------------------------------------------------*
...
/*:
 * @target MZ
 * @plugindesc 実績プラグインアドオン: ご褒美ピクチャー (v.1.1.0)
...
(function () {
    ...
    function getPluginName() {
        ...
        return match ? match[1] : 'TorigoyaMZ_Achievement2_AddonRewardPicture';
    }
