/*---------------------------------------------------------------------------*
 * TorigoyaMZ_Achievement2_AddonTileView.js v.1.2.0
 *---------------------------------------------------------------------------*
 * 2021/06/22 02:53 (JST)
 *---------------------------------------------------------------------------*
 * Ruたん ( @ru_shalm )
...
/*:
 * @target MZ
 * @plugindesc 実績プラグインアドオン: タイル表示 (v.1.2.0)
 * @author Ruたん（ru_shalm）
 * @license public domain
 * @version 1.2.0
 * @url https://raw.githubusercontent.com/rutan/torigoya-rpg-maker-plugin/gh-pages/TorigoyaMZ_Achievement2_AddonTileView.js
 * @base TorigoyaMZ_Achievement2
 * @orderAfter TorigoyaMZ_Achievement2
 * @help
 * 実績プラグインアドオン: タイル表示 (v.1.2.0)
 * https://torigoya-plugin.rutan.dev
 *
...
(function () {
    ...
    function getPluginName() {
        ...
        return match ? match[1] : 'TorigoyaMZ_Achievement2_AddonTileView';
    }
