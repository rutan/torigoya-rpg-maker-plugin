/*---------------------------------------------------------------------------*
 * TorigoyaMZ_CustomRegenerate.js v.1.0.0
 *---------------------------------------------------------------------------*
 * 2020/08/22 13:51 (JST)
 *---------------------------------------------------------------------------*
 * Ruたん ( @ru_shalm )
...
/*:
 * @target MZ
 * @plugindesc カスタムターン回復＆ダメージ設定プラグイン (v.1.0.0)
 * @author Ruたん（ru_shalm）
 * @license public domain
 * @version 1.0.0
 * @help
 * カスタムターン回復＆ダメージ設定プラグイン (v.1.0.0)
 *
...
(function () {
    ...
    function readParameter() {
        ...
        return {
            version: '1.0.0',
            advancedNoteTagHp: pickStringValueFromParameter(parameter, 'advancedNoteTagHp'),
            advancedNoteTagMp: pickStringValueFromParameter(parameter, 'advancedNoteTagMp'),
            advancedNoteTagTp: pickStringValueFromParameter(parameter, 'advancedNoteTagTp'),
        };
    }
