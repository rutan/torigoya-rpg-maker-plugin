/*---------------------------------------------------------------------------*
 * TorigoyaMZ_Achievement2_AddonCategory.js v.1.2.0
 *---------------------------------------------------------------------------*
...
/*:
 * @target MZ
 * @plugindesc 実績プラグインアドオン: カテゴリ設定 (v.1.2.0)
...
(function () {
    ...
    function getPluginName() {
        ...
        return match ? match[1] : 'TorigoyaMZ_Achievement2_AddonCategory';
    }
