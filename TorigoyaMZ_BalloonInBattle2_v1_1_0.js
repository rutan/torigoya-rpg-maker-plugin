/*---------------------------------------------------------------------------*
 * TorigoyaMZ_BalloonInBattle2.js v.1.1.0
 *---------------------------------------------------------------------------*
 * 2020/09/19 13:34 (JST)
 *---------------------------------------------------------------------------*
 * Ruたん ( @ru_shalm )
...
/*:
 * @target MZ
 * @plugindesc 戦闘中セリフ表示プラグイン (v.1.1.0)
 ...
 * @text セリフセットの変更
 * @desc セリフセットを別のものに変更します変更内容はセーブデータに反映されます
 *
 * @arg actorId
 * @text アクター
