/*---------------------------------------------------------------------------*
 * Torigoya_NiconikoBar.js v.1.3.1
 *---------------------------------------------------------------------------*
 * 2022/06/13 01:13 (JST)
 *---------------------------------------------------------------------------*
 * Ruたん ( @ru_shalm )
...
/*:
 * @target MV
 * @plugindesc ニコニ広告通知バー風表示プラグイン (v.1.3.1)
 * @author Ruたん（ru_shalm）
 * @license public domain
 * @version 1.3.1
 * @url https://raw.githubusercontent.com/rutan/torigoya-rpg-maker-plugin/gh-pages/Torigoya_NiconikoBar.js
 * @help
 * ニコニ広告通知バー風表示プラグイン (v.1.3.1)
 * https://torigoya-plugin.rutan.dev
 *
