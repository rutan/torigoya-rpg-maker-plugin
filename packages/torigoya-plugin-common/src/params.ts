...
export function parseBooleanParamList(
  value: string | boolean[] | undefined,
  defaultValue: boolean[]
): boolean[] {
...
export function parseIntegerParamList(
  value: string | number[] | undefined,
  defaultValue: number[]
): number[] {
  if (value === undefined || value === '') return defaultValue;
...
export function parseNoteStringParam(
...
export function parseNoteStringParamList(
  value: string | undefined,
  defaultValue: string[]
): string[] {
  if (value === undefined || value === '') return defaultValue;
...
export function parseNumberParamList(
  value: string | number[] | undefined,
  defaultValue: number[]
): number[] {
  if (value === undefined || value === '') return defaultValue;
...
export function parseStringParamList(
...
export function parseStructObjectParam<T>(
