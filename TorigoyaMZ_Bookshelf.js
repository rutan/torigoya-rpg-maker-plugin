/*---------------------------------------------------------------------------*
 * TorigoyaMZ_Bookshelf.js v.1.0.0
 *---------------------------------------------------------------------------*
 * 2020/10/05 03:40 (JST)
 *---------------------------------------------------------------------------*
 * Ruたん ( @ru_shalm )
...
/*:
 * @target MZ
 * @plugindesc テキスト本棚プラグイン (v.1.0.0)
...
(function () {
    ...
    function readParameter() {
        ...
        return {
            ...
            bookshelfWidth: pickIntegerValueFromParameter(parameter, 'bookshelfWidth', 320),
    ...
    class Scene_Bookshelf extends Scene_MenuBase {
        ...
        listWindowWidth() {
            return Torigoya.Bookshelf.parameter.bookshelfWidth;
        }
        ...
        bookContentWindowRect() {
            ...
            return new Rectangle(x, y, this.contentWindowWidth(), h);
        }
