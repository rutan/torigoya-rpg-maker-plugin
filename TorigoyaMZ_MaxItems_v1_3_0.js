/*---------------------------------------------------------------------------*
 * TorigoyaMZ_MaxItems.js v.1.3.0
 *---------------------------------------------------------------------------*
...
/*:
 * @target MZ
 * @plugindesc アイテム上限数個別指定プラグイン (v.1.3.0)
 * @author Ruたん（ru_shalm）
 * @license public domain
 * @version 1.3.0
 * @url https://raw.githubusercontent.com/rutan/torigoya-rpg-maker-plugin/gh-pages/TorigoyaMZ_MaxItems.js
 * @help
 * アイテム上限数個別指定プラグイン (v.1.3.0)
 * https://torigoya-plugin.rutan.dev
 *
 * アイテムの所持できる上限を
 * メモ欄で個別に設定できるようにします。
 ...
 * @command adjustItems
 * @text アイテム所持数の調整
 * @desc 最大所持数を超えたアイテムがある場合に
 * 上限を超えないようにアイテムを自動で減らします
 */
...
(function () {
    ...
    function getPluginName() {
        ...
        return match ? match[1] : 'TorigoyaMZ_MaxItems';
    }
